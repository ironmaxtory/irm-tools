<template lang="html">
  <div class="autoreload">
    ...
    <modal-interactive :modalShowed="showModal" :sel="autoreloadConfs" sel-key="exampleName"
...
import md5 from 'js-md5'; // js-md5插件
...
export default {
  ...
  methods: {
    ...
    stopProject () {
      ...
      if (platform === 'win32') {
        childProcess.exec('taskkill /pid ' + this.pid + ' /T /F');
      } else {
